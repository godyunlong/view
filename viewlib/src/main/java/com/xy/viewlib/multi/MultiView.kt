...
abstract class MultiView <T>:LinearLayout {
    ...
    var listener : MultiListener<T>?= null
    ...
    open fun initView(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            ajItemTextSelectNotColor = array.getColor(R.styleable.MultiView_aj_multi_select_not_color, getColor(context, R.color.black))
            ajItemTextSelectColor = array.getColor(R.styleable.MultiView_aj_multi_select_color, ajItemTextSelectNotColor)

            ajItemTextSelectNotSize = array.getDimension(R.styleable.MultiView_aj_multi_select_not_textSize, dp2px(context, 15F).toFloat())
