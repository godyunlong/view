...
abstract class PickerScrollView <T>: View {
    ...
    private fun initView(attrs: AttributeSet?){
        ...
        selectedTextColor = array.getColor(R.styleable.PickerScrollView_aj_pick_select_color,getColor(context, R.color.gray_3333))
        selectedNotTextColor = array.getColor(R.styleable.PickerScrollView_aj_pick_select_not_color,getColor(context, R.color.gray_3333))
        ...
        mMaxTextSize = array.getDimensionPixelOffset(R.styleable.PickerScrollView_aj_pick_max_textSize,dp2px(context,20F)).toFloat()
        mMinTextSize = array.getDimensionPixelOffset(R.styleable.PickerScrollView_aj_pick_min_textSize,dp2px(context,10F)).toFloat()
    }
